<?php
	...
	$lang->about_planet =
		"자신의 생각을 간단하게 적어 회원과 공유할 수 있는 XE 모듈입니다. 회원별로 플래닛을 생성하여 운영할 수 있습니다.
	...
	$lang->about_planet_url = '주소는 설정 후 변경할 수 없습니다.';
	$lang->planet_mytag = '인물 태그';
	$lang->about_planet_mytag = '나를 표현하는 태그로써 여러개의 태그는 쉼표로 구분 합니다.';

	$lang->about_planet_tag = '각 태그는 쉼표로 구분 합니다.';
	...
	$lang->planet_postscript = '덧붙임';
	$lang->planet_article_preview = '미리보기';


	$lang->planet_notice_title = "%s님 반갑습니다!<br>%s님의 생각, 의견, 정보, 지식 등을 자유롭고 편안하게 많은 분들과 나눌 수 있는 플래닛 입니다. 몇 가지 사용법을 안내해 드릴게요.^^";
	$lang->planet_notice_list = array(
		...
		"그 외 궁금하신 점은 '질문' 태그를 검색해 보세요. 다른 분들의 도움을 받을 수 있습니다.",
	);
